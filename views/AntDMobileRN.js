    ...
    return (
      <ScrollView style={[styles.container]}>
        ...
        <List renderHeader="Data Entry 数据输入">
          ...
          <Item
            arrow="horizontal"
            onClick={() => this.props.navigation.navigate('Radio')}
          >Radio
            <Brief>单选框</Brief>
          </Item>
          <Item
            arrow="horizontal"
            onClick={() => this.props.navigation.navigate('SearchBar')}
          >SearchBar 搜索框
            <Brief>一般可位于 NavBar 下方，通过『取消按钮』退出激活状态。</Brief>
          </Item>
          <Item
            arrow="horizontal"
            onClick={() => this.props.navigation.navigate('Slider')}
          >Slider 滑动输入条
            <Brief>允许用户在一个区间中选择特定值，eg：控制屏幕的显示亮度。</Brief>
          </Item>
          <Item
            arrow="horizontal"
            onClick={() => this.props.navigation.navigate('Stepper')}
          >Stepper 步进器
            <Brief>用作增加或者减少当前数值。</Brief>
          </Item>
          <Item
            arrow="horizontal"
            onClick={() => this.props.navigation.navigate('Switch')}
          >Switch 滑动开关
            <Brief>在两个互斥对象进行选择，eg：选择开或关。</Brief>
          </Item>
          <Item
            arrow="horizontal"
            onClick={() => this.props.navigation.navigate('TextareaItem')}
          >TextareaItem 多行输入
            <Brief>用于接受多行文本。</Brief>
          </Item>
        </List>
      </ScrollView>
    )
